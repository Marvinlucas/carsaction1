...
<head>
    ...
    <style>
        ...
        @media (min-width: 992px) {
            ...
            /* Adjust the height of the carousel images to fill the carousel */
            .carousel-item img {
                width: 100%;
                height: auto;
            }
...
//$sql .= " ORDER BY sellcars.price ASC"; // Order by price in ascending order
...
if ($result) {
    ...
    if (empty($row['image1']) || !file_exists($carCover)) {
        $carCover = $defaultImage; // Use the default image
            ...
            echo "<div class='card car-listing'><a href='revViewcar.php?car_id=$carId' class='card-link'>";
            echo "<img src='$carCover' class='card-img-top' alt='No Image Available'>"; // Replace the static image source with the dynamic variable
            ...
            echo "<p><b>Seller:</b> $sellerFirstName $sellerLastName</p>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
