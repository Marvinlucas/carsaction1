<?php
session_start();
require_once 'include/sender_message/config.php';
require_once 'include/sender_message/head.php';
// Check if the user is logged in
var_dump($_SESSION); 

if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
    $username = $_SESSION["username"];
    $buyer_id = $_SESSION["buyer_id"]; // Assuming you've set this during authentication
} else {
