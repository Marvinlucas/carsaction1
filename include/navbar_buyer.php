...
<body>
   <div class="container-fluid">
    ...
    <span id="notification-count"></span>
                ...
                <a href="buyerChatlist.php"><i class="fas fa-envelope"></i></a>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
            <h1 style="font-size: 25px">Buyer Platform</h1>
...
<!-- Accordion Section 2 -->
<li class="nav-item">
    <a class="nav-link" href="#" role="button" onclick="toggleAccordion('accordionSection2')">
        <i class="fas fa-chevron-right"></i> Accordion Section 2
    </a>
    <div class="collapse" id="accordionSection2">
        <div class="pl-3">
            <!-- Content for Accordion Section 2 goes here -->
