<div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active">
                    <a href="#homeSubmenu1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">&nbsp;<?php echo $_SESSION['username']; ?></a>
                ...
                <li>
                    <a href="userProfile.php">View my Profile</a>
                   
                </li>
                <li>
                    <a href="loanApproval.php">Loan Approval <span id="loan-count" class="badge badge-danger"></span></a> 
                </li>
                <li>
                    <a href="userSellcar.php">Sell your cars</a>
                </li>
                <li>
                    <a href="userCarlist.php">Your sell car list</a>
                </li>
                <li>
                    <a href="userLogs.php">Transaction history</a>
                </li>
            </ul>
...
<li class="list-unstyled CTAs">
    ...
    <ul class="list-unstyled components" style="display: flex;">
        <li style="flex: 1; padding: 0 10px;">
            <a href="userIndex.php"><i class="fa fa-home">Home</i></a>
        </li>
    ...
    <a href="notifications.php" id="notification-link">
        ...
        <li style="flex: 1; padding: 0 10px;">
            <a href="userChatlist.php" id="message-link"><i class="fa fa-commenting-o" aria-hidden="true"></i><span id="message-count" class="badge badge-danger"></span></a>
        </li>
    </ul>
</div>
                </div>
...
<script>
  ...
  var dropdownToggle = document.querySelector('a[data-toggle="collapse"]');
  
  // Get a reference to the dropdown menu
  var dropdownMenu = document.getElementById('homeSubmenu1');
  
  // Create a click event listener for the dropdown toggle
...
<script>
    $(document).ready(function() {
        // Show dropdown menu on mouseenter
        $('.dropdown').mouseenter(function() {
            $(this).find('.dropdown-toggle').stop(true, true).delay(100).fadeIn(200);
        });

        // Hide dropdown menu on mouseleave
        $('.dropdown').mouseleave(function() {
            $(this).find('.dropdown-toggle').stop(true, true).delay(100).fadeOut(200);
        });
    });
</script>
<script>
