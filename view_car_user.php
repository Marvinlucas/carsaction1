...
<body>
    <?php include('include/navbar_buyer.php'); ?>
    ...
    <div class="container">
        ...
        if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) {
            ...
            echo "<a href='chatContainer.php?sellers_id=" . $row['sellers_id'] . "' class='btn btn-primary'>Message</a>";
            echo "<a href='report.php?car_id=$carId' class='btn btn-danger'>Report</a>";
            echo "</div>";
        } else {
            echo "<div style='display: flex; justify-content: flex-end;'>";
            echo "<a href='login.php' class='btn btn-primary' style='margin-right: 10px;'>Message</a>";
            echo "<a href='report.php?car_id=$carId' class='btn btn-danger'>Report</a>";
            echo "</div>";
        }
        ?>
